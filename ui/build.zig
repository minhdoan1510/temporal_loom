...
const default_zero_native_path ="/Users/lap15138/.npm/_npx/5bf20bdb39c17d42/node_modules/zero-native";
const app_exe_name = "lending-claw";
...
pub fn build(b: *std.Build) void {
    ...
    const frontend_install = b.addSystemCommand(&.{ "pnpm", "--dir", "web", "install" });
    ...
    const frontend_build = b.addSystemCommand(&.{ "pnpm", "--dir", "web", "run", "build" });
